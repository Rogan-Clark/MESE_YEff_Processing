...
table_keys = ['VisibleEnergyMC','ReconstructedEnergyMonopod_L5',
                ...
                "MuonWeight_corrected2", "Inelasticity_param_a", "Inelasticity_param_b", "y_had", "y_lep", "y_neut", "TotalWeightPol", "y_eff_true", "E_close", "E_far",]

if int(filenum) in [22010, 22011, 22012, 22013, 22014, 22015, 22016, 22017, 22018]:
    outfile = "/data/user/rclark/TauSimProject/InelasicityHDF/L5_NewIce_%s_%sfiles_NewPolarisation_2XC_NoBadYEff" %(filenum, number_of_files)
elif int(filenum) in [21315, 21316, 21317, 21318, 21319]:
    outfile = "/data/user/rclark/TauSimProject/InelasicityHDF/L5_NewIce_%s_%sfiles_RemoveBadYEff" %(filenum, number_of_files)
elif int(filenum) in [2016, 2017]:
    outfile = "/data/user/rclark/TauSimProject/InelasicityHDF/L5_NewIce_Burn_%s_%sfiles_RemoveBadYEff" %(filenum, number_of_files)
elif int(filenum) in [2011, 2012, 2013, 2014, 2015, 2018, 2019, 2020, 2021]:
